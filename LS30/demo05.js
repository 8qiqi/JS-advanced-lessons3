...
test("a","b","c");//["a", "b", "c", callee: ƒ, Symbol(Symbol.iterator): ƒ]
...
f("a");//输出 "a",[]
f();//输出 undefined,[]
//思考function f(x,...y，z){console.log(y);}//此时y输出是什么  报错？
...
//Part333333333333 扩展知识 call与apply的转换 两者之间的区别 可通过...Rest和...Spread转换
function abc(...v){
    console.log(v)
}
o1 = {};
